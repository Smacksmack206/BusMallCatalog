...
Cart.prototype.getItemFromLocalStorage = function() {
  let itemInformation = localStorage.getItem('name');
  console.log(itemInformation);
  if(itemInformation) {
    let parsedItems = JSON.parse(CartItem);
    for (let name of parsedItems) {
